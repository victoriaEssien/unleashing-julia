...
# ╔═╡ 48d009e0-3836-4a12-a58c-35a024b78a51
begin
	using DataFrames
	using CSV
end

# ╔═╡ ccefeb96-24d8-4184-afad-3bbb0b6c5f16
using Plots  # This will install plots


# ╔═╡ 347672f2-39d2-4969-9ab5-6c42ccabab66
using PlutoUI


# ╔═╡ 0b31929e-0b98-4f84-826f-7c86f09be5fe
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 7b7f00c1-a66e-4a9c-8f93-cad557543e57
df.Country_code === df[!, "Country_code"]


# ╔═╡ cc7a6183-6380-48d5-8a07-132372d7d1e1
equals_sg(x::AbstractString) = x == "SG"


# ╔═╡ 7f21a595-23be-4a12-8b9d-79e6818159a0
sg_data = filter(:Country_code => equals_sg, df)


# ╔═╡ 566c0aef-dc37-4e2e-b0bc-c602a7836bdc
dates = sg_data[!, "Date_reported"]


# ╔═╡ 298a9720-924b-416f-a72b-5177ba1a5702
cumulative_cases = sg_data[!, "Cumulative_cases"]


# ╔═╡ d374c947-a8d6-4a77-b882-53b42bb4bbc1
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)


# ╔═╡ 6855920d-c7eb-4e9e-9cb8-192bfd65d5d8
...
# ╔═╡ b51885b1-f64d-4662-80cd-4b21737b8410
@bind slider_value Slider(0:10:1000)


# ╔═╡ b01d9bc3-6186-4a3d-b9e7-5d3684c1fae1
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ f34048d1-1664-44b4-81f0-b15fe4691edd
@bind date_slider_index Slider(1:length(dates))


# ╔═╡ f8e0993c-696d-4519-b854-53ee90f04cf4
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ acf28bfd-15aa-4456-8317-e23e74f25a1a
